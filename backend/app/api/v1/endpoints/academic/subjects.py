...
def list_subjects(
    ...
    return crud_academic.get_subjects(db, tenant_id=current_user["tenant_id"])
...
def get_subject(
    ...
    subject = crud_academic.get_subject(db, subject_id, tenant_id=current_user["tenant_id"])
    if not subject:
...
def create_subject(
    ...
    return crud_academic.create_subject(db, subject_in, tenant_id=current_user["tenant_id"])
...
def update_subject(
    ...
    """Update a subject."""
    subject = crud_academic.update_subject(db, subject_id, subject_in, tenant_id=current_user["tenant_id"])
    if not subject:
        raise HTTPException(status_code=404, detail="Subject not found")
    return subject
...
def delete_subject(
    ...
    """Delete a subject."""
    success = crud_academic.delete_subject(db, subject_id, tenant_id=current_user["tenant_id"])
    if not success:
        raise HTTPException(status_code=404, detail="Subject not found")
    return None
