...
export const getAllRoles = (): AppRole[] => {
  return ["SUPER_ADMIN", "TENANT_ADMIN", "DIRECTOR", "DEPARTMENT_HEAD", "TEACHER", "STUDENT", "PARENT", "ACCOUNTANT", "STAFF"];
};

// Get invitable roles (roles that can be assigned by admins)
export const getInvitableRoles = (): AppRole[] => {
  return ["DIRECTOR", "DEPARTMENT_HEAD", "TEACHER", "PARENT", "ACCOUNTANT", "STAFF", "STUDENT"];
};
