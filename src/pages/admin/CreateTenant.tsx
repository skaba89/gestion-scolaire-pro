...
const CreateTenant = () => {
  console.log("[SOVEREIGN] CreateTenant component loaded - Using apiClient for creation.");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("DEBUG - Tenant Creation Error:", error);
      toast({
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mt-2">
            <h1 className="text-3xl font-bold text-gray-900">SchoolFlow Pro</h1>
