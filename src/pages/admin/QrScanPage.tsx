    ...
    const handleScan = useCallback(async (qrData: string) => {
        try {
            ...
            const { data: student, error } = await supabase
                ...
                .or(`id.eq.${qrData},registration_number.eq.${qrData}`)
            ...
            // Log attendance (simplified direct call, normally uses an attendance hook)
            const { error: attError } = await supabase.rpc("log_student_check_in", {
            ...
            if (attError) {
                ...
                toast.error(`Erreur pour ${student.first_name}`);
                return;
            }
