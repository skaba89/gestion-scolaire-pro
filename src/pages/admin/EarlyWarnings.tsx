  ...
  const { data: alerts, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select(`
          *,
          student:student_id (id, first_name, last_name, registration_number),
          acknowledged_user:acknowledged_by (first_name, last_name),
          resolved_user:resolved_by (first_name, last_name)
        `)
