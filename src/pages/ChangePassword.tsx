...
const ChangePassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Auth update result:", { authData, passwordError });

      if (passwordError) throw passwordError;

      console.log("Updating profile must_change_password...");
      ...
      console.log("Password change successful. Initiating sign out...");
      ...
      // Navigate immediately to avoid UI hanging if signOut is slow
      // We perform signOut in background
      supabase.auth.signOut().then(() => {
        console.log("Sign out complete (background).");
      }).catch(err => {
        console.error("Sign out error (background):", err);
      });
