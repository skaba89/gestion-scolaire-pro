...
const ParentDashboard = () => {
  ...
  const { data: riskScores, isLoading: riskLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data } = await apiClient.get('/parents/risk-scores/', {
  ...
  return (
    <div className="space-y-6">
      ...
      {recommendations.length > 0 && <AnalyticsRecommendations recommendations={recommendations} />}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:col-span-2 gap-6">
          ...
          <div className="lg:col-span-2"><ReminderSystem /></div>
        </div>
      </div>
    </div>
  );
