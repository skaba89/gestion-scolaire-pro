        ...
        <div className="flex items-center justify-between p-4 border rounded-lg">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setConfig({ ...config, currentSequence: Math.max(1, parseInt(e.target.value) || 1) })}
              className="w-32 text-2xl font-bold font-mono"
            />
            <p className="text-xs text-muted-foreground">Prochain numéro : modifiez pour ajuster le compteur d'incrémentation.</p>
          </div>
