 ...
 */
export const RevenueTrendChart = ({ data, title = "Évolution des revenus", description }: ChartProps) => {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={data}>
                        ...
                        <YAxis />
                        <Tooltip
                            formatter={(value: number) => `${value.toLocaleString('fr-FR')} XAF`}
                        />
                        <Legend />
                        <Line
                            type="monotone"
 ...
 */
export const OutstandingByClassChart = ({ data, title = "Impayés par classe", description }: ChartProps) => {
    return (
        <Card>
            <CardHeader>
                <CardTitle>{title}</CardTitle>
