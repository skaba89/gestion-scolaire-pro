    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <KPICard
                ...
                value={`${(data?.overallSuccessRate ?? 0).toFixed(1)}%`}
                target={85}
                trend={{
                    value: 2.3,
                    direction: "up",
            ...
            <KPICard
                ...
                value={`${(data?.averageGrade ?? 0).toFixed(2)}/20`}
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <KPICard
                ...
                value={`${(data?.studentAttendanceRate ?? 0).toFixed(1)}%`}
                target={95}
            ...
            <KPICard
                ...
                value={`${(data?.teacherAttendanceRate ?? 0).toFixed(1)}%`}
                target={95}
                icon={<UserCheck className="w-4 h-4" />}
            ...
            <KPICard
                ...
                value={`${(data?.dropoutRate ?? 0).toFixed(1)}%`}
